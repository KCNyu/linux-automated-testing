...
if sys.argv[1] == "kselftest":
    ...
    data[usage] = (
        data["C Files with kselftest_harness.h"] / data["C Files with main/_start"] * 100
    )
else:
...
for bar in bars:
    ...
    axs[0].annotate(f'{height}', xy=(bar.get_x() + bar.get_width() / 2, height), xytext=(0, 3), textcoords="offset points", ha='center', va='bottom', fontsize=12, fontweight='bold')
